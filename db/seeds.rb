...
Watch.create([
  		{
  			name: "Backup Black",
  			brand: "Swatch",
  			description: "Add a sophisticated to every look with Backup Black.  This iconic style sports an easy to read dial in clean black and white Arabic numerals, indexes, and a date window.  A matching strap in black finishes the look.",
  			pre_owned: false,
  			price_in_pence: 5000,
  			gender: "unisex"
  			},
  		{
  			...
  			brand: "Casio",
  			description: "A stylish update of a classic Casio design, this retro timepiece is built for stellar contemporary styling.  The piece features a digital display and a flodover clasp.  Perfect for everyday and street styling.",
  			pre_owned: true,
  			price_in_pence: 4050,
  			gender: "unisex"},
  		{
